						...
						<div class="row-fluid">
							<div class="span3">
								<div class="user-profile-pic">	
									<img width="69" height="69" data-src-retina="<?php echo base_url(); ?>/<?php echo $profile['GAMBAR_PROFIL']; ?>" data-src="<?php echo base_url(); ?>/<?php echo $profile['GAMBAR_PROFIL']; ?>" src="<?php echo base_url(); ?>/<?php echo $profile['GAMBAR_PROFIL_KECIL']; ?>" />
								</div>
							</div>
