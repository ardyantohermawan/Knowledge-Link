                                ...
                                <div class="widget-container">
                                    <div class="widget-block">
                                        <div class="widget-content">
                                            <form action="<?php echo site_url('admin/sertifikasi/simpan'); ?>" method="POST" class="form-horizontal form-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="training_event_id" value="<?php echo (set_value('training_event_id')) ? set_value('training_event_id') : ''; ?>" class="form-control" placeholder="Masukkan training_event_id">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Course_id</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="course_id" value="<?php echo (set_value('course_id')) ? set_value('course_id') : ''; ?>" class="form-control" placeholder="Masukkan course_id">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Nama_training</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="nama_training" value="<?php echo (set_value('nama_training')) ? set_value('nama_training') : ''; ?>" class="form-control" placeholder="Masukkan nama_training">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Topik</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="topik" value="<?php echo (set_value('topik')) ? set_value('topik') : ''; ?>" class="form-control" placeholder="Masukkan topik">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Durasi</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="durasi" value="<?php echo (set_value('durasi')) ? set_value('durasi') : ''; ?>" class="form-control" placeholder="Masukkan durasi">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Start_date</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="start_date" value="<?php echo (set_value('start_date')) ? set_value('start_date') : ''; ?>" class="form-control" placeholder="Masukkan start_date">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">End_date</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="end_date" value="<?php echo (set_value('end_date')) ? set_value('end_date') : ''; ?>" class="form-control" placeholder="Masukkan end_date">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Tempat</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="tempat" value="<?php echo (set_value('tempat')) ? set_value('tempat') : ''; ?>" class="form-control" placeholder="Masukkan tempat">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Penyelenggara</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="penyelenggara" value="<?php echo (set_value('penyelenggara')) ? set_value('penyelenggara') : ''; ?>" class="form-control" placeholder="Masukkan penyelenggara">
                                                    </div>
                                                </div>
                                                <div class="form-group">
