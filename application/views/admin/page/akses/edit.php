                                ...
                                <div class="widget-container">
                                    <div class="widget-block">
                                        <div class="widget-content">
                                            <form action="<?php echo site_url('admin/akses/ubah/'.$akses['ID_AKSES']); ?>" method="POST" class="form-horizontal form-box">
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Level Akses</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="level_akses" value="<?php echo (set_value('level_akses')) ? set_value('level_akses') : $akses['LEVEL_AKSES'] ?>" class="form-control" placeholder="Enter text">
                                                    </div>
                                                </div>
                                                <div class="form-group">
