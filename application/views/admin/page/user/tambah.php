                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <select name="NIK" class="col-lg-12 select2">
                                                            ...
                                                            <option value="<?php echo $karyawan['NIK'] ?>" <?php echo (set_value('NIK') == $karyawan['NIK']) ? 'selected' : ''; ?>><?php echo $karyawan['NIK']; ?> - <?php echo $karyawan['NAMA']; ?> : <?php echo $karyawan['POSTITLE'] ?> <?php echo (isset($sertifikasis[$karyawan['NIK']]['TRAINING_EVENT_ID'])) ? '(Sertifikasi: '.$sertifikasis[$karyawan['NIK']]['NAMA_TRAINING'].')' : ''; ?></option>
                                                                <?php endforeach ?>
                                                            <?php endif ?>
