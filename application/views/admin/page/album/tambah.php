                                ...
                                <div class="widget-container">
                                    <div class="widget-block">
                                        <div class="widget-content">
                                            <form action="<?php echo site_url('admin/album/simpan'); ?>" method="POST" class="form-horizontal form-box" enctype="multipart/form-data" >
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <select name="user" class="col-lg-12 select2">
                                                            ...
                                                            <option value="<?php echo $karyawan['ID_user'] ?>" <?php echo (set_value('user') == $karyawan['ID_user']) ? 'selected' : ''; ?>><?php echo $karyawan['NIK']; ?> - <?php echo $karyawan['NAMA']; ?> : <?php echo $karyawan['POSTITLE'] ?></option>
                                                                <?php endforeach ?>
                                                            <?php endif ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <select name="album" class="col-lg-12 select2">
                                                            ...
                                                            <option value="Cover">Foto Sampul</option>
