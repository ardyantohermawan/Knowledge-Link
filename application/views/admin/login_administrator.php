...
<!--STYLESHEETS-->
<link href="<?php echo base_url();?>assets/style-form.css" rel="stylesheet" type="text/css" />
<!--SCRIPTS-->
...
<form name="login-form" class="login-form" action="<?php echo site_url('login_admin/login_form'); ?>" method="post">
	...
	<!--HEADER-->
    <div class="header">
    <!--TITLE--><h1>Login Administrator</h1><!--END TITLE-->
    <!--DESCRIPTION--><span>Masukkan Username dan Password.</span><!--END DESCRIPTION-->
    </div>
    <!--END HEADER-->
